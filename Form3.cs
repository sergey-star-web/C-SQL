...
namespace Задача1
{
    /*!
	 Дочерний класс
	\date Август 2020 года
	\warning Данный класс создан только в учебных целях

	Обычный дочерний класс, который отнаследован от ранее созданного класса Form
*/
    ...
    public partial class Form3 : Form
    {
        ...
        ///@{
        /*! \Функция Подключает базу данных и выводит значения таблицы Table
             \param sender, e
...
-долг
             \param sender, e
        Необходимо указать id студента которого хотите изменить
        */
        public async void button3_Click(object sender, EventArgs e);

        /*! \Функция Удаляет значения по Id:
      -Id
      -семестр
      -предмет
      -оценка
      -долг
             \param sender, e
        Необходимо указать id студента которого хотите удалить
        
        */
        public async void button2_Click(object sender, EventArgs e);

        /*! \обработчик события нажатия на кнопку статистика
             \param sender, e
