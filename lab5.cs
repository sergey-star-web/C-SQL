...
namespace task5
{
    class Shop
    {
        ...
        public Shop()
        {
            ...
            Console.WriteLine();
            Console.Write("Введите цену магазина: ");
            price = Convert.ToDouble(Console.ReadLine());
            Console.WriteLine();
        }

        public Shop(string worker, string product, int qty, double price)
        {
            this.worker = worker;
        ...
        public void Show()
        {
            Console.WriteLine("Name worker: " + worker + " name product: " + product + 
        ...
        public static Shop operator +(Shop s1, Shop s2)
        {
            ...
            return new Shop(s1.worker + " " + s2.worker, s1.product + " " + s2.product, s1.qty + s2.qty, s1.price + s2.price);
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            shop1.Show();
            Console.WriteLine();
            Shop shop2 = new Shop("Jhon", "cake",  25, 15.45);
            shop2.Show();
            Console.WriteLine();
            Shop shop3 = new Shop();
            shop3.Show();
